...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-pink-100 via-pink-50 to-pink-100 border-t border-pink-200 font-sans mt-10 relative overflow-hidden">
      {/* Dekorasi Latar */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 relative z-10">
        ...
        {/* COPYRIGHT */}
        <div className="border-t border-pink-200/60 pt-4 text-center text-xs text-gray-400 flex flex-col sm:flex-row justify-between items-center gap-3">
