        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5 pb-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {displayNewProducts.slice(newIndex, newIndex + 4).map((prod) => (
            <div
              ...
              className="w-[85vw] shrink-0 snap-center sm:w-auto bg-white rounded-3xl border border-pink-100 overflow-hidden shadow-xs hover:shadow-xl hover:border-pink-300 transition duration-300 flex flex-col justify-between cursor-pointer group p-3"
            >
        ...
        <div className="relative bg-pink-100/60  p-6 sm:p-10 rounded-3xl border border-pink-200 ">
          ...
          <div className="bg-white  rounded-2xl p-6 sm:p-10 shadow-lg border border-pink-100  relative z-10 max-w-5xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <h3 className="font-cursive font-bold text-pink-700  text-xl sm:text-3xl px-2 text-center leading-tight">
                Tentang Bloom & Bouquet
              </h3>
              <div className="flex-1 h-[1.5px] bg-pink-300 " />
            </div>

            <div className="space-y-4 text-center text-[10px] sm:text-sm text-pink-600/90  leading-relaxed font-sans">
              <p>
          ...
          <div className="block">
            <img src={aboutus1} alt="Bunga 1" className="absolute -top-3 -left-3 sm:-top-6 sm:-left-6 w-14 h-14 sm:w-28 sm:h-28 object-cover rounded-xl sm:rounded-2xl shadow-md border-2 border-white  -rotate-6" />
            <img src={aboutus2} alt="Bunga 2" className="absolute -bottom-3 -left-3 sm:-bottom-6 sm:-left-6 w-14 h-14 sm:w-28 sm:h-28 object-cover rounded-xl sm:rounded-2xl shadow-md border-2 border-white  -rotate-6" />
            <img src={aboutus3} alt="Bunga 3" className="absolute -top-3 -right-3 sm:-top-6 sm:-right-6 w-14 h-14 sm:w-28 sm:h-28 object-cover rounded-xl sm:rounded-2xl shadow-md border-2 border-white  -rotate-6" />
            <img src={aboutus4} alt="Bunga 4" className="absolute -bottom-3 -right-3 sm:-bottom-6 sm:-right-6 w-14 h-14 sm:w-28 sm:h-28 object-cover rounded-xl sm:rounded-2xl shadow-md border-2 border-white  -rotate-6" />
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 text-center space-y-8">
        <div className="flex items-center justify-center gap-2 sm:gap-4">
          ...
          <div className="space-y-1 px-2 text-center max-w-2xl mx-auto">
            <h2 className="text-xl sm:text-3xl md:text-4xl font-cursive font-bold text-pink-700  leading-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-6 bg-white  rounded-3xl border border-pink-100  shadow-xs flex flex-col items-center text-center space-y-3">
            ...
            <h3 className="font-bold text-sm text-pink-800 ">Kartu Ucapan Eksklusif</h3>
            <p className="text-xs text-gray-500  leading-relaxed">
